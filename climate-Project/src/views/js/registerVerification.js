function verification() {
  ...
  var myPassword = document.getElementById("inputPassword");
  var myConfirm = document.getElementById("confirmPassword");
  ...
  myPassword.onkeyup = function () {
    ...
    // Validate length
    if (myPassword.value.length >= minLength) {
  ...
  myConfirm.onkeyup = function () {
    ...
    var passEqualsConfPass = myPassword.value; // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
    if (passEqualsConfPass == myConfirm.value) {
